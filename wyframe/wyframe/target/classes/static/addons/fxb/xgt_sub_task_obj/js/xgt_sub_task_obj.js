...
layui.use('table', function(){
  ...
  table.render({
    ...
    {type:'checkbox', fixed: 'left'}
      ,{field:'task_obj_id',width:120,title: '作业对象ID',align:'center',fixed: '',sort: true }
      ,{field:'task_nm',width:120,title: '作业任务ID',align:'center',fixed: '',sort: true }
      ,{field:'id',width:120,title: '完成作业用户ID',align:'center',fixed: '',sort: true }
      ...
      ,{field:'cpn_nm',width:120,title: '企业信息ID',align:'center',fixed: '',sort: true }
