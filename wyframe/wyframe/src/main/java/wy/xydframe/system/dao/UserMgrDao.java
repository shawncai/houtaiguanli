...
import wy.common.persistence.model.Cpn_dept_user;
...
//    int selectUserRoleId(@Param("userNowId") Integer userNowId);
    ...
    Cpn_dept_user selectById(@Param("userId") Integer userId);
    /**
     * 根据部门ID查询部门名称
     *
     * @param 
    ...
    List<Map<String, Object>> list5(@Param("cpnId") Integer cpnId,@Param("name") String name,@Param("beginTime") String beginTime,@Param("endTime") String endTime,@Param("id") Integer id);
    ...
    List<Map> selectPageList2(@Param("cpnId") Integer cpnId,@Param("page") Page page,@Param("start") Integer start,@Param("rows") Integer rows,@Param("name") String name,@Param("beginTime") String beginTime,@Param("endTime") String endTime,@Param("id") Integer id);
