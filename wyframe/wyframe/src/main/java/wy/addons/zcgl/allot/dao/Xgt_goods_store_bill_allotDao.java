package wy.addons.zcgl.allot.dao;
 ...
 */
public interface Xgt_goods_store_bill_allotDao {

	List<Map<String, Object>> list(@Param("condition") String condition);


	Xgt_goods_store_bill_allot queryById(@Param("xgt_goods_store_billId") Integer xgt_goods_store_billId);
	...
	void updateTotal(@Param("shop_num") Integer shop_num, @Param("bill_req_id") Integer bill_req_id);
	void deleteDetail(@Param("bill_req_id") Integer bill_req_id);
	void updateSubmit(@Param("bill_req_id") Integer bill_req_id);
