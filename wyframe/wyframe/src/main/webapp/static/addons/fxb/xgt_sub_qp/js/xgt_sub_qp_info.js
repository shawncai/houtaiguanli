...
Xgt_sub_qpInfoDlg.collectData = function() {
    this.set('sub_qp_id').set('sub_qp_title').set('sub_id').set('sub_qp_seq').set('sub_exam_id').set('sub_qp_tp_id').set('sub_qp_ea_id').set('sub_qp_sel_a').set('sub_qp_sel_b').set('sub_qp_sel_c').set('sub_qp_sel_d').set('sub_qp_yes').set('sub_qp_no').set('sub_qp_answer').set('sub_qp_anl').set('spec_flg').set('mdi_dt').set('cre_dt').set('st_id').set('cpn_id');
}
