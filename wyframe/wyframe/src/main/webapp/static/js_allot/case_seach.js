...
$('#item_info_btn_add').click(function(){  
        ...
        parent.$("#condition").val(selectContent.cpn_store_nm);
    parent.$("#condition_hidden").val(selectContent.cpn_store_id);
...
$('#case_add').on('click', function(){
    layer.open({
      ...
      title: '仓库新增',
        ...
        maxmin: true,
        shadeClose: true,
      content:Feng.ctxPath +  '/xgt_goods_store_bill_allot/inStoreStoreAdd'
    });
  });