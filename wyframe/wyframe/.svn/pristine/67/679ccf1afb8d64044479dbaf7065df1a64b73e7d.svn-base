...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getPackageName() + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = contextConfig.getPathTemplate() + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = contextConfig.getPathTemplate() + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = contextConfig.getPackageName() + contextConfig.getModuleName() + ".service";
    }
