package wy.addons.fxb.xgt_sub_qp.model;
 ...
 */
 public class Xgt_sub_qp {
	...
	public Integer getSub_qp_seq() {
		return sub_qp_seq;
	}

	public void setSub_qp_seq(Integer sub_qp_seq) {
		this.sub_qp_seq = sub_qp_seq;
	}
}