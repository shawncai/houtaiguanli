package wy.addons.zcgl.cpn_dept.dao;
...
public interface Xyd_cpn_deptDao {
	 ...
	 * 获取企业组织管理列表
	 */
	List<Map<String, Object>> list(@Param("cpn_dept_id") Integer cpn_dept_id,@Param("cpnId") Integer cpnId,@Param("condition") String condition);
	/**
	 * 获取当前分支部门列表
	 */
