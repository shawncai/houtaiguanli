...
layui.use('table', function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{title: '名称', field: 'name',width:185,align:'center',fixed: 'left',sort: true }
            ,{title: '上级角色', field: 'pName',width:170,align:'center',fixed: '',sort: true }
            ,{title: '所在部门', field: 'deptName',width:150,align:'center',fixed: '',sort: true }
            ,{title: '别名', field: 'tips',width:240,align:'center',fixed: '',sort: true }
            ,{fixed: 'right',title : '操作',width:440, align:'center', toolbar: '#barDemo',}
        ]]
