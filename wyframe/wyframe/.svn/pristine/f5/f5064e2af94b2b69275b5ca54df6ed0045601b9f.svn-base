...
//        String rolename = theUser.getName();
//        System.err.println("当前点击角色名字是:" + rolename);
        
//        Integer roleNewId = Integer.parseInt(roleid);
        
//        String userRoleName = this.roleDao.getRoleName(roleid);
//        System.err.println("当前点击角色名字是:" + userRoleName);
        
        //获取当前登录用户角色ID和其所属角色ID       
        List<Integer> nowRolesIds = roleDao.getRolesId(userRoleId);
       
        //获取当前点击角色所被分配的角色菜单
//        List<Integer> onclickRolesId = roleDao.getOnclickRolesId(roleid);
        
        //获取当前点击角色的Pid
//  		Integer clickPid = roleDao.getOnclickRolesId(roleid);
//  		System.err.println("用户管理界面当前点击用户的PID是:" + clickPid);
