...
//*         corner - dom reference to corner xydframe
//*         cornerTable - dom reference to corner table
//*         scrollableColumns - dom reference to scrollable columns xydframe
//*         scrollableColumnsTable - dom reference to scrollable columns table
//*         scrollableRows - dom reference to scrollable rows xydframe
//*         scrollableRowsTable - dom reference to scrollable rows table
//*         scrollableWindow - dom reference to scrollable data xydframe
...
(function () {
    ...
    this.TableScroller = function (element, options) {
        ...
        if (options.pinnedRows > 0 && options.pinnedCols > 0) {
            ...
            ref.corner.className = "corner-xydframe";
        ...
        if (options.pinnedRows > 0) {
            ...
            ref.scrollableColumns.className = "scrollable-columns-xydframe";
        ...
        if (options.pinnedCols > 0) {
            ...
            ref.scrollableRows.className = "scrollable-rows-xydframe";
        ...
        ref.scrollableWindow.className = "scrollable-data-xydframe";
        ...
        // adjust scrollable columns xydframe to scrollable window with scroll bar width
        ...
        // adjust scrollable rows xydframe to scrollable window with scroll bar height
