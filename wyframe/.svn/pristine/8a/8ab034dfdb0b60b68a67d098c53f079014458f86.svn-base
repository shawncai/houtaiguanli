...
$('#tijiao').click(function(){
    ...
    var vendor=" "+","+$('#condition_hidden').val()+','+$('#condition1_hidden').val()+','+$('#condition2_hidden').val()+','+$('#hello').val()+','+$('#remark').val()+','+$('#outStore').html()+","+$("#totalAmount").html();
    console.log(vendor);
...
$('#baocun').click(function(){
    ...
    var vendor=$('#condition_hidden').val()+','+$('#condition1_hidden').val()+','+$('#condition2_hidden').val()+','+$('#hello').val()+','+$('#remark').val()+','+$('#outStore').html();
    console.log(vendor);
    var operation = function(){
        ...
        var ajax = new $ax(Feng.ctxPath + "/xgt_goods_store_bill_out/save_in", function (data) {
            Feng.success("提交成功!");
            window.load();
        }, function (data) {
            Feng.error("提交失败!" + data.responseJSON.message + "!");
