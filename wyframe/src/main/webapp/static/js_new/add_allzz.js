...
$(function () {
    ...
    var table = new BSTable("add_all", "/xgt_goods_store_bill/productList", defaultColunms);
...
Xyd_goods_store_bill_add.initColumn = function () {
    return [
        ...
        {title: '产品数量',editable:true,formatter:numb, field: 'num', align: 'center', valign: 'middle', sortable: true},
...
$('#item_info_btn_add').click(function(){  
    ...
    prd_id = $.map(selects, function (row) {
        return row.prd_id;
    });
    $('#add_all').bootstrapTable('remove', {
        field: 'prd_id',
        values: prd_id
    });
