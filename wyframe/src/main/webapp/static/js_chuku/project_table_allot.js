    ...
    $(function () {
     ...
     $('.gonghuo').on('click', function(){
      ...
      title: '供货商搜索',
        ...
        maxmin: true,
        shadeClose: true,
      content: Feng.ctxPath + '/xgt_goods_store_bill_out/inStoreVendorPage'
    });
  });
  ...
  $('#add_span').on('click', function(){
    layer.open({
      ...
      title: '供货商新增',
        ...
        maxmin: true,
        shadeClose: true,
        content:Feng.ctxPath +  '/xgt_goods_store_bill_out/inStoreVendorAdd'
    });
  });
 ...
 $('.case').on('click', function(){
      ...
      title: '仓库搜索',
        ...
        maxmin: true,
        shadeClose: true,
      content: Feng.ctxPath + '/xgt_goods_store_bill_out/inStoreStorePage'
    });
  });
