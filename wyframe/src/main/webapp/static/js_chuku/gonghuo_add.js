...
Xgt_goods_prd_vendorInfoDlg.collectData = function() {
	this .set('prd_vendor_id') .set('prd_vendor_nm') .set('prd_vendor_no') .set('man_phone') .set('man_address') .set('vendor_flg') .set('prd_vendor_man') .set('man_email') .set('remarks') ;
}
...
$('#ensure').click(function () {
    parent.$("#gonghuo").bootstrapTable('refresh');
