...
Wx_menu.initColumn = function () {
    return [
        ...
        {title: '菜单等级', field: 'btype', align: 'center', valign: 'middle', sortable: true}
,
        {title: '动作类型', field: 'type', align: 'center', valign: 'middle', sortable: true}
,
        {title: '菜单标题', field: 'name', align: 'center', valign: 'middle', sortable: true}
,
        {title: '菜单key值', field: 'key', align: 'center', valign: 'middle', sortable: true}
,
        {title: '网页链接', field: 'url', align: 'center', valign: 'middle', sortable: true}
,
        {title: '媒体ID', field: 'media_id', align: 'center', valign: 'middle', sortable: true}
    ];
};
...
Wx_menu.collectData = function() {
    this .set('id') .set('btype') .set('type') .set('name') .set('key') .set('url') .set('media_id');
}
