package wy.common.constant.dictmap.factory;

import wy.common.constant.dictmap.base.AbstractDictMap;
import wy.common.constant.dictmap.base.SystemDict;
...
public class DictMapFactory {
    ...
    private static final String basePath = "wy.common.constant.dictmap.";
