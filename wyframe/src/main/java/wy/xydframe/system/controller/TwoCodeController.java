...
public class TwoCodeController extends BaseController {
    private String PREFIX = "/xydframe/zshTwoCode/";
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "moduleName", value = "模块名称", required = true, dataType = "String"),
            ...
            @ApiImplicitParam(name = "fuTable", value = "副表名称", required = true, dataType = "String"),
            @ApiImplicitParam(name = "paramTable", value = "参数表", required = true, dataType = "String"),
            @ApiImplicitParam(name = "fuCols", value = "副表字段", required = true, dataType = "String"),
            @ApiImplicitParam(name = "paramCols", value = "参数字段", required = true, dataType = "String"),
    ...
    public Object add(String pcodeName, String pcode, String add, String detail, String update, String export,
                      ...
                      String table, String layout, String print,String project,String fuTable,String paramTable,String fuCols
                        ,String paramCols) {
...
//        }
        ...
        List<Map<String, Object>> fuList = (List<Map<String, Object>>) JSON.parse(fuCols.replaceAll("\\[],","").replaceAll(",\\[]",""));
        List<Map<String, Object>> paramList = (List<Map<String, Object>>) JSON.parse(paramCols.replaceAll("\\[],","").replaceAll(",\\[]",""));
        ...
        Collections.sort(fuList, new Comparator<Map<String, Object>>() {
            public int compare(Map<String, Object> o1, Map<String, Object> o2) {
                Integer name1 = Integer.valueOf(o1.get("order").toString()) ;//name1是从你list里面拿出来的一个
                Integer name2 = Integer.valueOf(o2.get("order").toString()) ; //name1是从你list里面拿出来的第二个name
                return name1.compareTo(name2);
...
//        contextConfig.setProjectPath("C:\\workspace\\wyframe");
        ...
        //副表名称
        contextConfig.setFuTable(fuTable);
        //参数表名称
        contextConfig.setParamTable(paramTable);
        //包路径
        ...
        //模板路徑
        contextConfig.setTemplatePath("zsh2");
        //内容
        contextConfig.setList(list);
        //副表内容
        contextConfig.setFuList(fuList);
        //参数表内容
        contextConfig.setParamList(paramList);
