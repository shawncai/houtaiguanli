package wy.rest.addons.zcgl.outStore.model;
 ...
 */
public class Xgt_goods_store_bill_out {


    private static final long serialVersionUID = 1L;

    @TableId(value = "bill_out_id", type = IdType.AUTO)
    private Integer bill_out_id;
    ...
    private double be_total_amounts;
    ...
    public Integer getOut_bill_type() {
        return out_bill_type;
    }

    public void setOut_bill_type(Integer out_bill_type) {
        this.out_bill_type = out_bill_type;
    }

    public Integer getBill_out_id() {
        return bill_out_id;
    }

    public void setBill_out_id(Integer bill_out_id) {
        this.bill_out_id = bill_out_id;
    }
    ...
    public String toString() {
        return "Xgt_goods_store_bill_allot{" +
                "bill_out_id=" + bill_out_id +
                ", bill_no='" + bill_no + '\'' +
                ", bill_dsc='" + bill_dsc + '\'' +
                ...
                ", st_id=" + st_id +
                ", oper_user='" + oper_user + '\'' +
                ", out_bill_type=" + out_bill_type +
                ", prd_vendor_id=" + prd_vendor_id +
                ", rel_bill_id=" + rel_bill_id +
                ", shop_num=" + shop_num +
                ", print_num=" + print_num +
                ", aud_st_id=" + aud_st_id +
                ", aud_user='" + aud_user + '\'' +
                ", be_total_amounts=" + be_total_amounts +
                '}';
    }
}