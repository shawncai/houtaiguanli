package wy.rest.addons.zcgl.outStore.dao;
 ...
 */
public interface Xgt_goods_store_bill_outDao {

	List<Map<String, Object>> list(@Param("condition") String condition);


	Xgt_goods_store_bill_out queryById(@Param("xgt_goods_store_billId") Integer xgt_goods_store_billId);
	...
	Map<String,Object>  selectStoreId(@Param("bill_out_id") Integer bill_out_id);
